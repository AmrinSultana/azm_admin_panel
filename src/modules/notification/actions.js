 ...
 */
export function showSuccess(message, dismissAfter) {
  if (dismissAfter == null) {
    dismissAfter = defaultDismissTime
  }
  return showNotification({ type: 'success', message, dismissAfter })
}
 ...
 * @param {String} message - Message to show
 */
export function showError(message, dismissAfter) {
  if (dismissAfter == null) {
    dismissAfter = defaultDismissTime
  }
  return showNotification({ type: 'error', message: `Error: ${message || ''}`, dismissAfter })
}
