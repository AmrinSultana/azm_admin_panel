...
const PROD_MESSAGING_ID = '366818957783'
...
firebase.initializeApp({
  ...
  messagingSenderId: !STAGE_MESSAGING_ID || self.location.hostname.includes('fir-test-e4371')
    ? PROD_MESSAGING_ID
    : STAGE_MESSAGING_ID
})
/* eslint-disable prettier/prettier */
...
messaging.setBackgroundMessageHandler(function (payload) {
  ...
  const notificationTitle = 'Azm_admin_panel'
